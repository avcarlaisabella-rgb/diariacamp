            ...
            <>
              ...
              <div className="hidden md:block bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
                <table className="w-full text-left text-xs table-fixed">
                  <thead className="bg-slate-50 text-slate-500 font-semibold border-b border-slate-200">
                    <tr>
                      <th className="w-[15%] px-3 py-3.5">Nº Recibo & Data</th>
                      <th className="w-[26%] px-3 py-3.5">Trabalhador & CPF</th>
                      <th className="w-[18%] px-3 py-3.5">Referência / Função</th>
                      <th className="w-[13%] px-3 py-3.5 text-right">Valor Líquido</th>
                      <th className="w-[11%] px-3 py-3.5 text-center">Assinatura</th>
                      <th className="w-[17%] px-3 py-3.5 text-right">Ação</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100">
                    {filteredReceipts.map(p => (
                      <tr key={p.id} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="px-3 py-3.5 text-center">
                          {p.isReverted ? (
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-rose-50 text-rose-700 border border-rose-200 text-[10px] font-bold" title={`Revertido: ${p.reversalReason}`}>
                              <RotateCcw className="w-3 h-3 text-rose-600" />
                              <span>Estornado</span>
                            </span>
                          ) : p.signedByWorker ? (
